/*
* Merge Sort:
* Merge sort is another divide and conquer type of sorting. In order to divide
* and conquer we need to create the middle point. To create this we need to
* divide the the array length by 2, we keep splitting the array till they are in
* pairs or single. Then we compare the pairs and add the next pair adjacent to
* them and compare them. This process continues until the entire array is sorted.
* This system works well for bigger arrays
*/
